...
minimumMotionUnitZ = round((1 / value), 4) #Should be 0.0025 but we gotta do the math.
...
for stepcount in tqdm(arange(0.0, 6.0, round(minimumMotionUnitZ*5,4))):
    ...
    print(f"Step height done:\t{round(stepcount, 4)}")